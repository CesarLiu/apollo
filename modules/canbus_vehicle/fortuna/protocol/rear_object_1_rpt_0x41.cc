...
#include "modules/canbus_vehicle/fortuna/protocol/rear_object_1_rpt_0x41.h"
...
RearObject1rpt0x41::RearObject1rpt0x41() {}
const int32_t RearObject1rpt0x41::ID = 0x41;

void RearObject1rpt0x41::Parse(const std::uint8_t* bytes, int32_t length,
                           ChassisDetail* chassis_detail) const {
    if(rear_tracked(bytes, length)){
        chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_tracked(Rear_object_1_Rear_trackedType_OBJECT_MEASURED);                             
    }
    else{
        chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_tracked(Rear_object_1_Rear_trackedType_OBJECT_TRACKED);                             
    }

    chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_id(rear_id(bytes, length));
    chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_pos_y(rear_pos_y(bytes, length));
    chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_rel_velocity_x(rear_rel_velocity_x(bytes, length));
    chassis_detail->mutable_fortuna()->mutable_rear_object_1()->set_rear_pos_x(rear_pos_x(bytes, length));
}
...
int RearObject1rpt0x41::checksum(const std::uint8_t* bytes, 
...
bool RearObject1rpt0x41::rear_tracked(const std::uint8_t* bytes, 
...
// ''}
// ID of RearObject
int32_t RearObject1rpt0x41::rear_id(const std::uint8_t* bytes, 
                             const int32_t length) const{
...
double RearObject1rpt0x41::rear_pos_y(const std::uint8_t* bytes, 
                                 const int32_t length) const{
...
double RearObject1rpt0x41::rear_rel_velocity_x(const std::uint8_t* bytes, 
                                         const int32_t length) const{
...
double RearObject1rpt0x41::rear_pos_x(const std::uint8_t* bytes, 
                                 const int32_t length) const{
