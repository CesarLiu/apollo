...
#include "modules/canbus_vehicle/fortuna/protocol/front_object_3_rpt_0x33.h"
...
FrontObject3rpt0x33::FrontObject3rpt0x33() {}
const int32_t FrontObject3rpt0x33::ID = 0x33;

void FrontObject3rpt0x33::Parse(const std::uint8_t* bytes, int32_t length,
                           ChassisDetail* chassis_detail) const {
    chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_rel_velocity_x(rel_velocity_x(bytes, length));                           
    chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_rel_pos_y(rel_pos_y(bytes, length));                           
    chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_rel_pos_x(rel_pos_x(bytes, length));                           
    chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_id(id(bytes, length));                           
    if(fused_state(bytes, length)){
        chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_fused_state(Front_object_3_Fused_stateType_OBJECT_FUSED);                           
    }
    else{
        chassis_detail->mutable_fortuna()->mutable_front_object_3()->set_fused_state(Front_object_3_Fused_stateType_NOT_FUSED);
    }
...
int FrontObject3rpt0x33::checksum(const std::uint8_t* bytes, 
...
double FrontObject3rpt0x33::rel_velocity_x(const std::uint8_t* bytes, 
...
double FrontObject3rpt0x33::rel_pos_y(const std::uint8_t* bytes, 
                             const int32_t length) const{
...
double FrontObject3rpt0x33::rel_pos_x(const std::uint8_t* bytes, 
                                 const int32_t length) const{
...
// ''}
// ID of FrontObject
int32_t FrontObject3rpt0x33::id(const std::uint8_t* bytes, 
                         const int32_t length) const{
...
bool FrontObject3rpt0x33::fused_state(const std::uint8_t* bytes, 
                             const int32_t length) const{
