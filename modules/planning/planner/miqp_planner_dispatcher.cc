...
#include "modules/planning/planner/miqp_planner_dispatcher.h"
...
std::unique_ptr<Planner> MiqpPlannerDispatcher::DispatchPlanner(
    const PlanningConfig& planning_config,
    const std::shared_ptr<DependencyInjector>& injector) {
  auto planner_type = PlannerType::MIQP;
